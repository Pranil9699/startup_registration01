 ...
 <c:forEach var="ideationtable" items="${ideationT}">
									...
									<tr class="border border-dark">
										...
										<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a
											...
											href='updatefile.jsp'>File</a></td>
										<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a
											class="btn btn-primary"
											href='updatephoto.jsp'>Photo</a></td>
									</tr>
								 </c:forEach>
								</tbody>
							</table>
			...
			<br> <br> <br>
			<div
				class="row rounded-2 px-4 fs-6 bg-light ">
				<div class="mt-3 mb-4">
					<div class="row">
						<div class="col-md-12">
								...
								<table
									...
									<tbody class="">
										...
										if(count==0){
											%>
											<tr class="border border-dark"> 
											<td colspan="8" class="text-center ">Team Member Data Are Not Inserted
											</td></tr>
